    ...
    <section className="section-divider relative">
      <Swiper
        ...
        pagination={{
          clickable: true,
          bulletClass:
            "swiper-pagination-bullet !h-2 !w-2 !bg-white/40 !opacity-70",
          ...
          <SwiperSlide key={slide.id}>
            <div className="relative h-full">
              <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary/75 via-primary/78 to-[#071821]/92" />
              </div>

              <div className="relative z-10 h-full">
                <div className="mx-auto flex h-full max-w-6xl flex-col justify-center px-4 py-10 md:px-6 lg:px-8">
                  <div className="max-w-xl space-y-5 text-white md:space-y-6">
                    ...
                    <p className="max-w-md text-sm text-white/85 md:text-[0.97rem]">
                      {slide.subtitulo}
                    </p>
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <Button
                        ...
                        variant="secondary"
                        size="lg"
                        className="border-white/30 bg-transparent text-white hover:border-accent/70 hover:bg-accent hover:text-primary"
                      >
                        Ver coberturas
                      </Button>
                    </div>
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-5 z-20 flex items-center justify-center">
        <div className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-black/30 px-4 py-2 text-[11px] text-accent/90 backdrop-blur-sm">
